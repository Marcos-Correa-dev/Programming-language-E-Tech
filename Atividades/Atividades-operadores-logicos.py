...
# reprovado_por_falta =# Insira aqui a expressão lógica usando NOT e/ou Operadores Relacionais
#
# # B. Critério de Aprovação
# # APROVADO se a frequência FOR suficiente E a média for alta.
# aprovado = frequencia # Insira aqui a expressão lógica usando AND e Operadores Relacionais
#
...
# recuperacao = frequencia # Insira aqui a expressão lógica usando AND, NOT, e Operadores Relacionais
#
